...
def main():
    ...
    parser.add_argument("--video", type=str, help="Input video path", default="../examples/Sample/id1_id9_0000_fake.mp4")
    parser.add_argument("--out_dir", type=str, help="Output directory", default="../examples/Sample")
    parser.add_argument("--model_path", type=str, help="Model checkpoint path", default="../weights/PwTF_weights.pth")
    ...
    for clip in tqdm(clips_for_video, desc="Processing clips"):
        ...
        ft_images = torch.from_numpy(ft_images).to(device)
